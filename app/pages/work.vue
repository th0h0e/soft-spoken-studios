  ...
  <div>
    ...
    <UiContainer class="-mt-8 pb-16">
      <div class="grid gap-8 gap-y-4 lg:grid-cols-8">
        ...
        <!-- Row 6: Professional Services Firm -->
        <div class="lg:col-span-5">
          <PortfolioItem
            :images="[
