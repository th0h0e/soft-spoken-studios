export default defineAppConfig({
  ...
  site: {
    ...
    description:
      "An at your service creative agency, specializing in telling stories through copywriting and video.",
  ...
  seo: {
    ...
    description:
      "Creative communication and strategic storytelling. We write your talk and capture your walk.",
    keywords: [
      "creative agency",
      "copywriting",
      "video production",
  ...
  // CTA Button Labels (Global - Stay in English)
  cta: {
