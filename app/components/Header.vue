        ...
        <slot>
          ...
          <div class="flex flex-col gap-3 sm:flex-row">
            <UiButton size="sm" variant="outline" as-child>
              <NuxtLink to="/work">{{ appConfig.cta.viewWork }}</NuxtLink>
            </UiButton>

            <UiDrawer>
              <UiDrawerTrigger as-child>
                <UiButton size="sm">{{ appConfig.cta.getInTouch }}</UiButton>
              </UiDrawerTrigger>
...
Please include your email or phone number so we can get back to you."
                      ...
                      <UiDrawerFooter class="p-4">
                        <div class="flex gap-3">
                          ...
                          >
                            {{ isSubmitting ? appConfig.cta.sending : appConfig.cta.send }}
                          </UiButton>
                    ...
                    <div class="lg:col-span-3">
                      <div class="p-4">
                        <div>
                          ...
                          <p class="text-muted-foreground text-sm">
                            Location: {{ appConfig.contact.address }}
                          </p>
                        </div>
                      </div>
                    </div>
