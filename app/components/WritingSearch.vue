  ...
  <div class="space-y-4">
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        >
          <template #leading>
            <Icon name="lucide:search" class="text-muted-foreground h-4 w-4" />
          </template>
        </UiInput>
      </div>
      ...
      <!-- Clear Filters -->
      <div v-if="hasActiveFilters" class="border-t pt-2">
        <UiButton
          @click="clearFilters"
          variant="ghost"
          size="sm"
...
<script setup>
  ...
  const hasActiveFilters = computed(() => {
    return searchQuery.value.length > 0 || selectedTags.value.length > 0;
  });
